...
namespace Gecko.Utils
{
	...
	public static class WindowsImageCreator
	{
		...
		public static Bitmap CanvasGetBitmap(this GeckoWebBrowser browser, uint width, uint height)
		{
		...
		public static Bitmap CanvasGetBitmap(this GeckoWebBrowser browser, uint xOffset, uint yOffset, uint width, uint height)
		{

...
namespace Gecko.Certificates
{
		...
		: System.IEquatable<Certificate>
	{
		...
		{
			get { return Create( _cert.Instance.GetIssuerAttribute() ); }
		}
		...
		{
			return _cert.Instance.VerifyForUsage( usage );
		}
		...
		{
			// now nsIX509Cert is allways nsIX509Cert3
			return new Certificate( ( nsIX509Cert3 ) certificate );
		}

...
namespace Gecko.Cryptography
{
	...
	public sealed class CryptoHash
	{
		...
		{
			_cryptoHash.Instance.UpdateFromStream( stream._inputStream.Instance, ( uint ) count );
		}

		public void UpdateFromStream(Gecko.IO.InputStream stream)
		{
			_cryptoHash.Instance.UpdateFromStream( stream._inputStream.Instance, 0xFFFFFFFF );
		}

...
namespace Limaki.Drawing.Indexing.QuadTrees {
    ...
    public class Quadtree<TItem> {
        ...
        public static Envelope EnsureExtent(Envelope itemEnv, double minExtent) {
            ...
            return Envelope.FromLTRB((float)minx, (float)miny, (float)maxx, (float)maxy);
        }
        ...
        /// <returns></returns>
        public virtual ICollection<TItem> Query(Envelope searchEnv) {
        ...
        public virtual void Query(Envelope searchEnv, IItemVisitor<TItem> visitor) {
            /*
            * the items that are matched are the items in quads which
            * overlap the search envelope
            */
        ...
        public virtual Coordinate QueryRightBottom(Command<ICollection<TItem>, Coordinate> maxCommand) {

...
namespace Limaki.Widgets {
    public class Scene : IGraphScene<IWidget,IEdgeWidget>, IWidget, IComposite<IWidget> {
        ...
        private ISpatialIndex<IWidget> _spatialIndex = null;
        public ISpatialIndex<IWidget> SpatialIndex {
            get {
        ...
        private Action<IGraphScene<IWidget, IEdgeWidget>, IWidget> _focusChanged = null;
        public Action<IGraphScene<IWidget, IEdgeWidget>, IWidget> FocusChanged {
            get { return _focusChanged; }
            set { _focusChanged = value; }
        }

        private WidgetComposite<Set<IWidget>> _selectedItems = null;
        public virtual IComposite<IWidget> Selected {
            get {
            ...
            set { _selectedItems = value as WidgetComposite<Set<IWidget>>; }
        }
        ...
        public virtual IShape ItemShape(IWidget item) {
            return item.Shape; 
        }

        private ICollection<ICommand<IWidget>> _commands = new List<ICommand<IWidget>>();
        public ICollection<ICommand<IWidget>> Requests {

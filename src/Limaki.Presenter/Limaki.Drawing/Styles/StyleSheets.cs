    ...
    public class StyleSheets : Dictionary<string, IStyleSheet> {
        ...
        public virtual IStyleSheet PredefinedStyleSheets(string name) {
            ...
            if (name == "WhiteGlass") {
                ...
                _styleSheet.EdgeStyle.PenColor = DrawingExtensions.FromArgb(150, 180, 180, 180);
                ...
                _styleSheet.EdgeStyle.SelectedStyle.TextColor = DrawingExtensions.FromArgb(200, 50, 50, 50);
                _styleSheet.EdgeStyle.SelectedStyle.PenColor = DrawingExtensions.FromArgb(50, 180, 180, 180);

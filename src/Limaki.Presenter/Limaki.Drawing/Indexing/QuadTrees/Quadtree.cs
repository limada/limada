...
namespace Limaki.Drawing.Indexing.QuadTrees {
    ...
    public class Quadtree<TItem> {
        ...
        public static RectangleD EnsureExtent(RectangleD itemEnv, double minExtent) {
            ...
            return RectangleD.FromLTRB((double)minx, (double)miny, (double)maxx, (double)maxy);
        }
        ...
        public virtual void Add(RectangleD itemEnv, TItem item) {
        ...
        /// <returns></returns>
        public virtual ICollection<TItem> Query(RectangleD searchEnv) {
        ...
        public virtual void Query(RectangleD searchEnv, IItemVisitor<TItem> visitor) {
            /*
            * the items that are matched are the items in quads which
            * overlap the search envelope
            */
        ...
        /// </summary>
        /// <param name="itemEnv"></param>
        private void CollectStats(RectangleD itemEnv) {
        ...
        public virtual void QueryBounds(
            ...
            Root<TItem> root, Func<TItem, RectangleD> getBounds) {
            var l = left;
            var t = top;
            var r = right;
            var b = bottom;

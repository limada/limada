...
namespace Limaki.Drawing.Indexing.QuadTrees {
    ...
    public abstract class NodeBase<TItem> {
        ...
        /// <returns></returns>
        protected abstract bool IsSearchMatch(RectangleS searchEnv);
        ...
        public virtual void AddAllItemsFromOverlapping(RectangleS searchEnv, ref IList<TItem> resultItems) {
        ...
        public virtual void Visit(RectangleS searchEnv, IItemVisitor<TItem> visitor) {
            if (!IsSearchMatch(searchEnv))
                return;

...
namespace Limaki.Drawing.Indexing.QuadTrees {
    ...
    public abstract class NodeBase<TItem> {
        ...
        public static int GetSubnodeIndex(RectangleD env, Point centre) {
        ...
        public virtual bool Remove(RectangleD itemEnv, TItem item) {
        ...
        public virtual bool Remove(RectangleD nodeEnv, NodeBase<TItem> node) {
            // use envelope to restrict nodes scanned
        ...
        /// <returns></returns>
        protected abstract bool IsSearchMatch(RectangleD searchEnv);
        ...
        public virtual void AddAllItemsFromOverlapping(RectangleD searchEnv, ref IList<TItem> resultItems) {
        ...
        public virtual void Visit(RectangleD searchEnv, IItemVisitor<TItem> visitor) {
            if (!IsSearchMatch(searchEnv))
                return;
        ...
        /// <param name="searchEnv"></param>
        /// <param name="visitor"></param>
        protected virtual void VisitItems(RectangleD searchEnv, IItemVisitor<TItem> visitor) {

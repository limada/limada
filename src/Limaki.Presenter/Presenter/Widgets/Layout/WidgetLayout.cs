...
namespace Limaki.Presenter.Widgets.Layout {
    public class WidgetLayout<TItem, TEdge> : GraphLayout<TItem, TEdge>
        where TItem :  IWidget
        where TEdge:  TItem, IEdge<TItem> {
        public WidgetLayout(Get<IGraphScene<TItem, TEdge>> handler, IStyleSheet stylesheet)

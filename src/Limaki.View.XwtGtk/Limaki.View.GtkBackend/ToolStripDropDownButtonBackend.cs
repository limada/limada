...
namespace Limaki.View.GtkBackend {
    ...
    public class ToolStripDropDownButtonBackend : ToolStripDropDownButtonBackendBase<Gtk.ToolItem> {
    }

    public class ToolStripDropDownButtonBackend1 : ToolStripDropDownButtonBackendBase<GtkToolButton> {

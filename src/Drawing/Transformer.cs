...
namespace Limaki.Drawing {
    ...
    public class Transformer:TransformerBase {
        ...
        public Transformer(Matrice matrice) {
    ...
    public class DelegatingTransformer : TransformerBase {
        public delegate Matrice MatrixHandler();

        MatrixHandler _transform = null;
        public DelegatingTransformer(MatrixHandler transform) {
        ...
        public override Matrice Matrice {
            ...
            set { throw new  NotSupportedException ("setting the Matrix in DelegatingTransformer is not supported"); }
        }
        #endregion

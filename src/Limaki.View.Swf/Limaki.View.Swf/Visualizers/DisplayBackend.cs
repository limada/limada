...
namespace Limaki.View.Swf.Visualizers {
    ...
    public abstract class DisplayBackend<T> : DisplayBackend, IGdiBackend, IDisplayBackend<T>, IDragDropControl {
        ...
        protected override void OnGiveFeedback (SWF.GiveFeedbackEventArgs e) { base.OnGiveFeedback (e); }

        //this is called by Control.DoDragDrop
        protected override void OnQueryContinueDrag (SWF.QueryContinueDragEventArgs e) { base.OnQueryContinueDrag (e); }

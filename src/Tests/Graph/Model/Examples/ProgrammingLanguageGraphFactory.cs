...
namespace Limaki.Tests.Graph.Model {
    public class ProgrammingLanguageFactory : GraphFactoryBase {
        ...
        public override void Populate(IGraph<IGraphItem, IGraphEdge> Graph, int start) {
            ...
            edge = new GraphEdge(Link[1], Node[3]);
            Graph.Add(edge);
            Link[2] = edge;
            ...
            edge = new GraphEdge(Link[1], Node[4]);
            Graph.Add(edge);
            Link[3] = edge;
            ...
            edge = new GraphEdge(Link[5], Node[7]);
            Graph.Add(edge);
            Link[6] = edge;

            edge = new GraphEdge(Link[2], Node[7]);
            Graph.Add(edge);
            Link[9] = edge;
            ...
            edge = new GraphEdge(Link[5], Node[8]);
            Graph.Add(edge);
            Link[7] = edge;

            edge = new GraphEdge(Link[3], Node[8]);
            Graph.Add(edge);
            Link[8] = edge;

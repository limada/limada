...
namespace Limaki.Tests.Widget {
    public class LongtermPerformanceData : SceneTestData {
        public LongtermPerformanceData(): base() {
            Count = 0;
        }
        public override string Name {
            get { return "Longterm Performance"; }
        }
        ...
        public class LongtermPerformanceLayout:BasicWidgetLayout<Scene,IWidget> {
        ...
        public override Scene Scene {
            get {
                ...
                for (int i = 0; i < Count; i++) {
                    LongtermPerformanceData example = new LongtermPerformanceData ();

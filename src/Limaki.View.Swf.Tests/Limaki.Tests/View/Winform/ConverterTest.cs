        ...
        public void KeyEventArgsTest() {
            for (Keys keys = Keys.None; keys <= Keys.BrowserBack; keys++) {
                ...
                if (keys == Keys.LWin || keys == Keys.RWin) {
                    Assert.IsTrue(
                       args2.Modifiers == ModifierKeys.Command,
                       Enum.GetName(typeof(ModifierKeys), args2.Modifiers));
                    continue;
                }
                ...
                Assert.IsTrue (
                    args2.Modifiers == ModifierKeys.Control,
                    Enum.GetName(typeof(ModifierKeys), args2.Modifiers));
                ...
                Assert.IsTrue(
                    (args2.Modifiers == ModifierKeys.Alt),
                    Enum.GetName(typeof(ModifierKeys), args2.Modifiers));
                ...
                Assert.IsTrue(
                    (args2.Modifiers == ModifierKeys.Shift),
                    Enum.GetName(typeof(ModifierKeys), args2.Modifiers));
                ...
                Assert.IsTrue(
                    args2.Modifiers == (ModifierKeys.Shift|ModifierKeys.Control),
                    Enum.GetName(typeof(ModifierKeys), args2.Modifiers));
            }
        }
    }

...
namespace Limada.View {
    public class SceneProvider : ISceneProvider {
        ...
        protected virtual bool Open(Action openProvider) {
            //Close();
            if (BeforeOpen != null) {
        ...
        public virtual IThingGraph Export(Scene scene) {
            ...
            if (graph != null) {
                ...
                return Provider.Export(thingView);
            }

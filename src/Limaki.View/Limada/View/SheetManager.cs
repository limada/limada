...
namespace Limada.View {
    ...
    public class SheetManager : ISheetManager {
        ...
        public SheetInfo SaveToThing(Scene scene, ILayout<Scene, IWidget> layout, SheetInfo info) {
        ...
        public SheetInfo SaveToThing(Scene scene, ILayout<Scene, IWidget> layout, IThing thing, string name) {
        ...
        public void LoadSheet(Scene scene, ILayout<Scene, IWidget> layout, Stream stream) {

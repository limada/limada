...
namespace Limaki.View.Viz.Visualizers.Toolbars {
    ...
    [BackendType (typeof (IMarkerToolbarBackend))]
    public class MarkerToolbar : DisplayToolbar<IGraphSceneDisplay<IVisual, IVisualEdge>> {

        public MarkerToolbar () {
            Compose ();
        }

        protected virtual void Compose () {
            MarkerCombo = new ComboBox { Width = 100 };
            MarkerComboHost = new ToolbarItemHost { Child = MarkerCombo };
        ...
        protected ToolbarItemHost MarkerComboHost { get; set; }
    ...
    public interface IMarkerToolbarBackend : IDisplayToolbarBackend {
    }
}
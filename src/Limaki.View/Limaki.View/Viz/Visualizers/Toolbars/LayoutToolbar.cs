...
namespace Limaki.View.Viz.Visualizers.Toolbars {
    ...
    [BackendType (typeof (ILayoutToolbarBackend))]
    public class LayoutToolbar : DisplayToolbar<IGraphSceneDisplay<IVisual, IVisualEdge>> {
        ...
        protected virtual void Compose () {
            ...
            var styleSheetComboHost = new ToolbarItemHost { Child = StyleSheetCombo };
            ...
            var shapeComboHost = new ToolbarItemHost { Child = ShapeCombo };
    ...
    public interface ILayoutToolbarBackend : IDisplayToolbarBackend {

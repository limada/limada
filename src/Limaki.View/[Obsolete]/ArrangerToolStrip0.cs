...
namespace Limaki.View.Viz.Visualizers.ToolStrips {
    ...
    public class ArrangerToolStrip0 : DisplayToolStrip0<IGraphSceneDisplay<IVisual, IVisualEdge>, IArrangerToolStripBackend> {

        public ToolStripCommand0 LogicalLayoutCommand { get; set; }
        public ToolStripCommand0 LogicalLayoutLeafCommand { get; set; }
        public ToolStripCommand0 FullLayoutCommand { get; set; }
        public ToolStripCommand0 ColumnsCommand { get; set; }
        public ToolStripCommand0 OneColumnCommand { get; set; }
        public ToolStripCommand0 ArrangeLeftCommand { get; set; }
        public ToolStripCommand0 ArrangeCenterCommand { get; set; }
        public ToolStripCommand0 ArrangeRightCommand { get; set; }
        public ToolStripCommand0 ArrangeTopCommand { get; set; }
        public ToolStripCommand0 ArrangeCenterVCommand { get; set; }
        public ToolStripCommand0 ArrangeBottomCommand { get; set; }
        public ToolStripCommand0 DimensionXCommand { get; set; }
        public ToolStripCommand0 DimensionYCommand { get; set; }
        public ToolStripCommand0 UndoCommand { get; set; }

        public ArrangerToolStrip0() {
            Compose();
        }
        ...
        protected virtual void Compose () {
            ...
            LogicalLayoutCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            LogicalLayoutLeafCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            FullLayoutCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            ColumnsCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            OneColumnCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            ArrangeLeftCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            ArrangeCenterCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            ArrangeRightCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            ArrangeTopCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            ArrangeCenterVCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            ArrangeBottomCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            DimensionXCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            DimensionYCommand = new ToolStripCommand0 {
                Action = (s) => {
            ...
            UndoCommand = new ToolStripCommand0 {
                Action = (s) => Undo(),
                Size = DefaultSize,
                Image = Iconery.Undo,

...
namespace Limaki.Graphs {
    ...
    [Obsolete("this was included in GraphPair")]
    public class LiveGraphPair<TSinkItem, TSourceItem, TSinkEdge, TSourceEdge> : GraphPair0<TSinkItem, TSourceItem, TSinkEdge, TSourceEdge>

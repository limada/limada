...
namespace Limaki.Winform.Widgets {
    ...
    /// DragDrop support
    /// </summary>
    public class WidgetDragDrop : MouseDragActionBase, IDragDropAction, IKeyAction {
        ...
        public WidgetDragDrop( Func<Scene> sceneHandler, IDragDopControl control, ICamera camera , ILayout<Scene, IWidget> layout)
            : this() {

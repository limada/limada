...
namespace Limaki.View.Ui.DragDrop0 {
    ...
    public class DragDropViz0 {
        ...
        public TransferDataSource SetVisual (IVidgetBackend backend, IGraph<IVisual, IVisualEdge> graph, IVisual visual) {
            var dataObject = new VidgetBackendTransferDataSource();
            dataObject.Backend = backend;

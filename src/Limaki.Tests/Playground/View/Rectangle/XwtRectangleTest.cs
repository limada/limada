...
using Xwt;
using System;
using Rectangle = Xwt.RectangleD;
...
namespace Limaki.Tests.Sandbox {
    ...
    public class XwtRectangleTest  {
        ...
        public static RectangleD IntersectMonoWindowBase(RectangleD r1, RectangleD r2) {
            ...
            return new RectangleD(_x, _y, _width, _height);
        }

        public static RectangleD IntersectMonoSystemDrawing(RectangleD r1, RectangleD r2) {
            ...
            if (!intersectsWithInclusive())
                return RectangleD.Zero;
            return RectangleD.FromLTRB(Math.Max(r1.Left, r2.Left),

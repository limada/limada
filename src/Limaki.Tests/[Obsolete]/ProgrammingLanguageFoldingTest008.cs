...
namespace Limaki.Tests.Graph.Wrappers {
    ...
    public class ProgrammingLanguageFoldingTest008 : SceneFacadeTest008<ProgrammingLanguageFactory> {
        ...
        public void Programming() {
            ...
            Mock.Scene.Focused = Mock.Factory.Nodes[1]; // Programming
            ...
            Mock.Scene.Selected.Clear();
            Mock.Scene.Focused = Mock.Factory.Nodes[5];//"Library"
            Mock.Display.Layout.Perform(Mock.Scene.Focused);
            Mock.SceneFacade.Expand(false);
            ...
            Mock.Scene.Selected.Clear();
            Mock.Scene.Focused = Mock.Factory.Nodes[6]; //"Collections"
            Mock.Display.Layout.Perform(Mock.Scene.Focused);
            ...
            Mock.Scene.Selected.Clear();
            Mock.Scene.Focused = Mock.Factory.Nodes[4]; //"Net"
            Mock.Display.Layout.Perform(Mock.Scene.Focused);
            ...
            Mock.Scene.Selected.Clear();
            Mock.Scene.Focused = Mock.Factory.Nodes[2]; //"Language"
            Mock.Display.Layout.Perform(Mock.Scene.Focused);
            ...
            Mock.Scene.Selected.Clear();
            Mock.Scene.Focused = Mock.Factory.Nodes[3]; //"Java"
            Mock.Display.Layout.Perform(Mock.Scene.Focused);
        ...
        public void Net() {
            ...
            Mock.Scene.Selected.Clear();
            Mock.Scene.Focused = Mock.Factory.Nodes[8];//"IList"
            Mock.Display.Layout.Perform(Mock.Scene.Focused);
            Mock.SceneFacade.Expand(false);
            ...
            Mock.Scene.Selected.Clear();
            Mock.Scene.Focused = Mock.Factory.Edges[8]; // [[[Programming->Language]->.NET]->IList]
            Mock.Display.Layout.Perform(Mock.Scene.Focused);
            Mock.SceneFacade.CollapseToFocused();
        ...
        public void ProgrammingLanguageEdge() {
            Mock.Scene.Selected.Clear();
            Mock.Scene.Focused = Mock.Factory.Edges[1]; // Programming
            Mock.SceneFacade.CollapseToFocused();

    ...
    public class LineTextTest : WidgetDisplayTest {
        ...
        public override void Setup() {
            ...
            if (!Display.EventControler.Actions.ContainsKey(typeof(WidgetBoundsLayer))) {
                widgetBoundsLayer = new WidgetBoundsLayer(Display.Camera);
        ...
        public void LineTextHover() {
            ...
            lineCenter = Display.Camera.FromSource (lineCenter);
            MouseActionEventArgs e =
                new MouseActionEventArgs(MouseActionButtons.Left, 
                    ModifierKeys.None,
                    0, lineCenter.X, lineCenter.Y, 0);
        ...
        void Display_Paint(object sender, PaintEventArgs e) {
            ...
            PointI[] hull = 
                layout.GetDataHull (Data.Edge[1], Display.Camera.Matrice, 0, true);

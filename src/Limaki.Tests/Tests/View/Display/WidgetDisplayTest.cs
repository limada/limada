...
namespace Limaki.Tests.Widget {
    public class WidgetDisplayTest : DisplayTest<WidgetDisplay,Scene> {
        ...
        public void NeutralPosition() {
            MouseActionEventArgs e = new MouseActionEventArgs(MouseActionButtons.Left, 0, 1, 1, 0);
        ...
        protected virtual void MoveAlongLine(Vector v) {
            ...
            while (rangeX() || rangeY()) {
                ...
                e = new MouseActionEventArgs(MouseActionButtons.Left, 0, (int)tnext.X, (int)tnext.Y, 0);
                Display.EventControler.OnMouseMove(e);
                Application.DoEvents();

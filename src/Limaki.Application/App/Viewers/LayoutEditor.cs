...
namespace Limaki.Winform.Viewers {
    public partial class LayoutEditor : BaseStyleEditor<WidgetLayout<Scene,IWidget>> {
        public LayoutEditor() {
            InitializeComponent();
        }

        protected override void SetEditorFromLayout(WidgetLayout<Scene,IWidget>  layout) {
            disableChanges = true;
            this.Distance = GDIConverter.Convert(layout.Distance);
        ...
        public Size Distance {
            ...
            set {
                ...
                this.SelectedObject.Distance = GDIConverter.Convert (value);

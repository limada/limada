...
namespace Limaki.Winform.Displays {
    ...
    where T : class {
        ...
        public ILayer<T> DataLayer {
            get {
                if (_dataLayer == null) {
                    EventControler.Add(_dataLayer = displayKit.Layer(this, this));
                }
                return _dataLayer;
            }
            ...
            get {
                if (_selectAction == null) {
                    EventControler.Add(_selectAction =
                        displayKit.SelectAction(this, DataLayer.Camera));
                }
        ...
        public virtual ZoomAction ZoomAction {
            get {
                if (_zoomAction == null) {
                    EventControler.Add(_zoomAction = new ZoomAction(this, this, DataLayer.Camera));
                }
                return _zoomAction;
            }
        ...
        protected override void OnMouseMove(MouseEventArgs e) {
            base.OnMouseMove(e);
            EventControler.OnMouseMove(e);
        }

        protected override void OnMouseUp(MouseEventArgs e) {
            base.OnMouseUp(e);
            EventControler.OnMouseUp(e);
        }

        protected override void OnKeyDown(KeyEventArgs e) {
            base.OnKeyDown(e);
            EventControler.OnKeyDown(e);
        }
        protected override void OnKeyPress(KeyPressEventArgs e) {
            base.OnKeyPress(e);
            EventControler.OnKeyPress(e);
        }
        protected override void OnKeyUp(KeyEventArgs e) {
            base.OnKeyUp(e);
            EventControler.OnKeyUp(e);
        }
        #endregion
